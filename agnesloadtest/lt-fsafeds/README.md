...
find yourenv -type f -exec sed -i '' 's/lt-fsafeds/yoursp/g' '{}' \;
find yourenv -type f -exec sed -i '' 's/urn:gov:gsa:openidconnect.profiles:sp:sso:healthequity:lt-fsafeds/yoururn/g' '{}' \;
```
