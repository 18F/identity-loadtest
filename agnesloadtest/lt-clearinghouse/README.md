...
find yourenv -type f -exec sed -i '' 's/lt-clearinghouse/yoursp/g' '{}' \;
find yourenv -type f -exec sed -i '' 's/urn:gov:gsa:openidconnect.profiles:sp:sso:fmcsa:lt-clearinghouse/yoururn/g' '{}' \;
```
