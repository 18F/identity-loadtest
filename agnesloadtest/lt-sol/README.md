...
find yourenv -type f -exec sed -i '' 's/lt-sol/yoursp/g' '{}' \;
find yourenv -type f -exec sed -i '' 's/urn:gov:opm:openidconnect.profiles:sp:sso:servicesonline:lt-sol/yoururn/g' '{}' \;
```
