...
find yourenv -type f -exec sed -i '' 's/lt-pspd-ttp-prod/yoursp/g' '{}' \;
find yourenv -type f -exec sed -i '' 's/urn:gov:dhs:openidconnect.profiles:sp:sso:cbp:lt-pspd-ttp-prod/yoururn/g' '{}' \;
```
