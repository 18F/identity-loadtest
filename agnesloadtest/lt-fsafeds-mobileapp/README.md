...
find yourenv -type f -exec sed -i '' 's/lt-fsafeds-mobileapp/yoursp/g' '{}' \;
find yourenv -type f -exec sed -i '' 's/urn:gov:gsa:openidconnect.profiles:sp:sso:healthequity:lt-fsafeds-mobileapp/yoururn/g' '{}' \;
```
