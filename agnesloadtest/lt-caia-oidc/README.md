...
find yourenv -type f -exec sed -i '' 's/lt-caia-oidc/yoursp/g' '{}' \;
find yourenv -type f -exec sed -i '' 's/urn:gov:gsa:openidconnect.profiles:sp:sso:treasury:lt-caia-oidc/yoururn/g' '{}' \;
```
